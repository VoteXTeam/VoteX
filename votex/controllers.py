...
from votex.models import Voter, GlobalElection, LocalElection, Location, Vote, Election, Candidate
...
class VoterController:
    ...
    def create_user_from_data(self, password: str, **kwargs):
        ...
        kwargs['username'] = kwargs['passport_id']
    ...
    def get_elections_by_voter(self):
        voter = self.voter
        local_elections_for_voter: LocalElection = LocalElection.objects.filter(Q(location=voter.location) | Q(location=None))
