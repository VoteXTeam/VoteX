...
from votex.views import RegisterUserAPI, RetrieveElectionsAPI, LocationsAPI, LoginUserAPI, VotingAPI, \
...
urlpatterns = [
    ...
    path('api/electionById/<int:election_id>', GetElection.as_view(), name='get-election'),
